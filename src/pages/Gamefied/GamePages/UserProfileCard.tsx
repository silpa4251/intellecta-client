const UserProfileCard = ({user, userstats}) => {
  return (
    <div className="cards">
      <div className="outlinePage">
        ...
        <p className="ranking_number">
          H<span className="ranking_word">ello</span>
        </p>
        ...
        <p className="userName">{user?.name|| "Unknown"}</p>
      </div>
      <div className="detailPage">
        ...
        <div className="gradesBox">
          ...
          <p className="gradesBoxNum">{userstats?.totalScore || 0}</p>
        </div>
      </div>
    </div>
  );
