...
//           <div className="flex flex-col gap-3 px-4 py-3 overflow-y-auto flex-grow scrollbar-hidden chatbot-message-div">
//             {messages.map((msg, i) => (
//               <motion.div
//                 key={i}
...
//                   msg.fromBot ? "bg-white text-black self-start" : "bg-[#395e71] text-white self-end"
//                 }`}
//               >
//                 <h1 className="text-xs font-semibold">{msg.fromBot ? "Intellecta" : "You"}</h1>
...
//       >
//         <img src={Robot} alt="robot-chat" className="w-16 h-20 animate-bounce" />
//       </motion.div>
//     </div>
//   );
// };
  ...
  return (
    <div className="fixed bottom-5 right-5 flex flex-col items-end z-50">
      ...
      <motion.div
        ...
        onClick={() => setIsOpen(!isOpen)}
      >
        <img src={Robot} alt="robot-chat" className={`w-16 h-20 ${!isOpen &&"animate-bounce"}`} />
      </motion.div>
    </div>
  );
};
